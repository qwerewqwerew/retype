...
- [1. 기본문법](#1-기본문법)
	...
	- [1.3. 연산자](#13-연산자)
		...
		- [1.3.5. 논리연산자](#135-논리연산자)
			...
			- [1.3.5.2. 마무리문제-\[11\]](#1352-마무리문제-11)
			- [1.3.5.3. 마무리문제-\[12\]](#1353-마무리문제-12)
		- [1.3.6. 조건부연산자](#136-조건부연산자)
			- [1.3.6.1. 예제-\[13\]](#1361-예제-13)
			- [1.3.6.2. 마무리문제-\[14\]](#1362-마무리문제-14)
			- [1.3.6.3. 마무리문제-\[15\]](#1363-마무리문제-15)
		- [1.3.7. 연산자의 우선순위](#137-연산자의-우선순위)
...
!!!info
자바스크립트에서 연산자 우선순위는 표현식 내에서 연산자가 어떤 순서로 평가되는지를 결정하는 규칙입니다. 이 규칙에 따라 표현식의 평가 순서와 결과가 달라질 수 있습니다.
!!!
|우선순위|연산자|
|---|---|
|1. |`( )`|
