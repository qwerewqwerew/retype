...
- [2. 내장객체](#2-내장객체)
	...
	- [2.4. Date객체-\[04\]](#24-date객체-04)
		- [2.4.1. 현재날짜출력하기](#241-현재날짜출력하기)
		- [2.4.2. 특정날짜출력하기](#242-특정날짜출력하기)
		- [2.4.3. 자바스크립트의 날짜,시간 입력방식](#243-자바스크립트의-날짜시간-입력방식)
		- [2.4.4. Date 객체의 메서드](#244-date-객체의-메서드)
		- [2.4.5. 날짜계산하는 프로그램 만들기](#245-날짜계산하는-프로그램-만들기)
...
window 객체는 웹브라우저 상태를 제어하며 자바스크립트의 최 상위에 있습니다.
