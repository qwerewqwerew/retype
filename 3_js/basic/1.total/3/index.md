...
1. [1. 함수](#1-함수)
	1. [1.1. 함수의 선언과 호출](#11-함수의-선언과-호출)
		1. [1.1.1. 함수의 선언-예제](#111-함수의-선언-예제)
			1. [1.1.1.1. 함수의 호출-예제](#1111-함수의-호출-예제)
	2. [1.2. 변수의 호이스팅](#12-변수의-호이스팅)
		1. [1.2.1. 지역변수](#121-지역변수)
			1. [1.2.1.1. 예제](#1211-예제)
		2. [1.2.2. 전역변수](#122-전역변수)
			1. [1.2.2.1. 예제](#1221-예제)
		3. [1.2.3. var의 호이스팅](#123-var의-호이스팅)
			1. [1.2.3.1. 예제](#1231-예제)
		4. [1.2.4. var의 재선언과 재할당](#124-var의-재선언과-재할당)
			1. [1.2.4.1. 예제](#1241-예제)
		5. [1.2.5. let 과 const](#125-let-과-const)
			1. [1.2.5.1. let-예제](#1251-let-예제)
			2. [1.2.5.2. const-예제](#1252-const-예제)
	3. [1.3. 재사용가능한 함수 만들기](#13-재사용가능한-함수-만들기)
		1. [1.3.1. 매개변수,인수,return](#131-매개변수인수return)
			1. [1.3.1.1. 그림으로 이해하는 매개변수,인수,return](#1311-그림으로-이해하는-매개변수인수return)
			2. [1.3.1.2. 매개변수를 사용한 함수만들기-예제-\[08\]](#1312-매개변수를-사용한-함수만들기-예제-08)
		2. [1.3.2. 매개변수의 기본값 지정하기](#132-매개변수의-기본값-지정하기)
			1. [1.3.2.1. 매개변수의 기본값 지정하기-예제](#1321-매개변수의-기본값-지정하기-예제)
		3. [1.3.3. 실습문제](#133-실습문제)
	4. [1.4. 함수표현식](#14-함수표현식)
		1. [1.4.1. 익명함수-예제](#141-익명함수-예제)
		2. [1.4.2. 즉시실행함수-예제](#142-즉시실행함수-예제)
		3. [1.4.3. 화살표함수-예제\[13\]](#143-화살표함수-예제13)
		4. [1.4.4. 선언적 함수를 활용한 갤러리-예제](#144-선언적-함수를-활용한-갤러리-예제)
	5. [1.5. 콜백함수](#15-콜백함수)
		1. [1.5.1. 예제](#151-예제)
2. [2. 이벤트](#2-이벤트)
	1. [2.1. 이벤트](#21-이벤트)
		1. [2.1.1. 마우스이벤트](#211-마우스이벤트)
		2. [2.1.2. 키보드이벤트](#212-키보드이벤트)
		3. [2.1.3. 문서로딩이벤트](#213-문서로딩이벤트)
		4. [2.1.4. 폼이벤트](#214-폼이벤트)
	2. [2.2. 이벤트처리기](#22-이벤트처리기)
		1. [2.2.1. HTML 속성을 이용한 방식-버튼 클릭시 알림창표시-예제\[14\]](#221-html-속성을-이용한-방식-버튼-클릭시-알림창표시-예제14)
		2. [2.2.2. 버튼 클릭시 배경변경-예제\[15\]](#222-버튼-클릭시-배경변경-예제15)
		3. [2.2.3. 버튼 클릭시 상세설명 표시-예제\[16\]](#223-버튼-클릭시-상세설명-표시-예제16)
		4. [2.2.4. DOM을 이용한 방식-버튼클릭시 글자변경-예제\[17\]](#224-dom을-이용한-방식-버튼클릭시-글자변경-예제17)
		5. [2.2.5. addEventListener 메서드를 활용한 예시](#225-addeventlistener-메서드를-활용한-예시)
3. [3. 마무리문제](#3-마무리문제)
...
||| [:icon-play:](./script/var-3.html) hoisting
...
||| Code [:icon-play:](./script/addNumber-3.html)
...
+++ 지시문
[!badge variant='primary' icon="download" size='m' text='파일다운로드' target="\_blank"](./img.zip)

[:icon-play:](./script/gallery.html) 선언적 함수를 사용하여 이미지 갤러리를 만들어 보겠습니다
+++ 코드
...
+++ 코드2
콜백함수를 활용하는 setTimeOut

||| setTimeOut
**지정시간 이후에 콜백함수를 실행 합니다.** [:link:MDN](https://developer.mozilla.org/en-US/docs/Web/API/setTimeout)
[!badge variant='primary' size='m' text='기본형'] `setTimeout(함수,시간)`{.red}
...
||| clearTimeOut
setTimeOut 을 취소합니다. [:link: MDN](https://developer.mozilla.org/en-US/docs/Web/API/clearTimeout)
[!badge variant='primary' size='m' text='기본형'] `clearTimeout(timeoutID)`{.red}
...
||| setInterval
**지정시간 마다 콜백함수를 실행합니다.** [:link:MDN](https://developer.mozilla.org/en-US/docs/Web/API/setInterval)
[!badge variant='primary' size='m' text='기본형'] `setInterval(함수,시간)`{.red}
...
||| clearInterval
setInterval 을 취소합니다. [:link:MDN](https://developer.mozilla.org/en-US/docs/Web/API/clearInterval)
[!badge variant='primary' size='m' text='기본형'] `clearInterval(intervalID)`{.red}
