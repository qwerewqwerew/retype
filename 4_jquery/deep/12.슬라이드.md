...
- [1. 기본 슬라이드](#1-기본-슬라이드)
- [2. 메인비주얼 슬라이드](#2-메인비주얼-슬라이드)

## 1. 기본 슬라이드

+++ 지시문 [!ref target='blank' text=':icon-play:미리보기'](https://qwerewqwerew.github.io/source/jq/12/12b-jq.html) [!badge variant='primary' size='l' text='다운로드' icon='download'](https://qwerewqwerew.github.io/source/jq/12/img.zip)
